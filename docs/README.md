...
代码级导航：[Code Wiki](./code-wiki/README.md)（架构、模块、关键类与函数、依赖、运行和测试方式；生成时基线见 Wiki 首页）。

2026-09-03 开发分支补充：[Runtime 可靠性修复](./ops/RUNTIME-RELIABILITY-2026-09-03.md)。尚未发布或经生产验收，不替换下述已验收基线。
