...
- ENV：ADR-ENV-001 至 ADR-ENV-005 已由 PR #80 冻结；ENV-1B1A、ENV-1B2P、ENV-1B1B、ENV-1B1C-B1/B2 和 ENV-1B2A 已分别合并。ENV-1B2B 的 CPython 3.14.6 / cp314 与 OPS Release Manifest v2 repository implementation 已独立验收，`ENV_1B2_completed=true`；`ENV_1B3_started=false`，activation、formal Release 和 production approval 均未完成。
- OPS：[ops/](./ops/)
