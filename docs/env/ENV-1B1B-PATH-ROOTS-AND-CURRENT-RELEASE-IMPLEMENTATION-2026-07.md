...
`2220ebccfea0194d1bfe4c5720f6da134e30babc6a42d86259c0e665e888f0d0`。
...
| W41 | migrated_state_primitive | `atomic_write_current_release` 是独立 `STATE_ROOT` persistent-state primitive；没有 activation call site。 |
...
current-release malformed/duplicate/residual `.new`、临时所有权故障注入、两阶段解析，以及
FastAPI startup、canvas/conversation/history/SQLite/upload/preview/OPS fixture/runtime log 的隔离路径验证。
