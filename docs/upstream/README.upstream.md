> 本文档为上游原版 README，仅作参考，不是企业版项目首页入口。
>
> This document is the upstream README from hero8152/Infinite-Canvas. It is kept for reference only and is not the Enterprise project entry point.
