...
- 实施状态：Manifest v2 repository implementation 已通过独立审查，Release candidate payload 可构建、离线验证，portable startup 已绑定 v2；OPS-3B、restore、rollback 和 activation 尚未实现
