...
- OPS Release Manifest v2：当前单一 Draft PR 实施 detached manifest、Git-tree payload、闭合 inventory、deterministic archive、Runtime/static/SBOM/licenses/config/database 绑定、offline verifier/materializer 与 portable v2 identity。`Manifest_v2_repository_implementation_present=true`、`Manifest_v2_independent_acceptance_pending=true`；activation、OPS-3B、formal Release、clean Windows 和 production approval 仍为 false。实现边界见 [OPS Release Manifest v2 实施记录](./ops/OPS-RELEASE-MANIFEST-V2-IMPLEMENTATION-2026-07.md)。
