...
- ENV-1B2A：本分支以官方 CPython `3.10.11` Windows x64 embeddable ZIP、完整哈希锁、闭合 wheelhouse 和固定 build policy 完成两次独立 clean build。Build A/B 的 Runtime tree SHA-256 均为 `6dbeb669533b082a0fe5ca01239692288388df3d27ba4338f6bfe8f5aa6b9887`，archive SHA-256 均为 `f57d50c4184f4fe6d07dc86423b4d266455f976d2011894838aa3526ca6c09c0`；现有 verifier 得出 core/dependency/archive 均为 `true`，但 `production_approved=false`。实现与脱敏摘要见 [ENV-1B2A 实施记录](./env/ENV-1B2A-REPRODUCIBLE-WINDOWS-RUNTIME-IMPLEMENTATION-2026-07.md)。
