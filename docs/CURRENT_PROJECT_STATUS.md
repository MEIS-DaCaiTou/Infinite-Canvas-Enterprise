...
- 当前稳定 main / origin/main：`d2351a5854fa96589bb89503747a7e2e61feb80a`
- 当前上游版本：`2026.07.6`
...
当前进入 OPS-0 / OPS-0A 生产只读盘点文档化阶段。由于已有早期版本上线生产，且生产环境与开发 / Codex 环境隔离，3G-8 暂时后置但不取消。
...
确认 HEAD 为 `d2351a5854fa96589bb89503747a7e2e61feb80a` 或其后的 main。若 main 已前进，先读取最新 `PROJECT_SCOPE_LOCK.md`、本文件和最近 PR，再开始新任务。
