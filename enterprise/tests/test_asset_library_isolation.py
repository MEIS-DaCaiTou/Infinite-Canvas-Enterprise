...
async def _run_checks() -> None:
    with tempfile.TemporaryDirectory(prefix="ice-asset-library-") as raw_tmp:
        ...
        edb.init_db()
        user_a = insert_ready_user_fixture(edb.DB_PATH, username="asset_a", password_hash=edb._hash_password("password-a"), display_name="Asset A")
        user_b = insert_ready_user_fixture(edb.DB_PATH, username="asset_b", password_hash=edb._hash_password("password-b"), display_name="Asset B")
