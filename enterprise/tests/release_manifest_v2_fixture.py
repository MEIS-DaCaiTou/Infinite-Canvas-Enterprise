...
def release_manifest(*, release_id: str = "release-A", runtime_manifest_sha256: str = "c" * 64, python_version: str = "3.14.6", python_abi: str = "cp314", architecture: str = "x64"):
    ...
    payload = {
        ...
        "upstream_source": {"repository": "hero8152/Infinite-Canvas", "commit": "f1dd6834a72f3e7ff8340be05a84347d931e9cb9", "tree": "ebcc3b2df68aa6ee4f43ffd5f9fc392ac7d70dbc", "version": "2026.07.6", "version_file_sha256": "07ed50de51e151a77869e9edd7be52d23a7890b0f5f4b9b4b9d75f8d6d90c374"},
