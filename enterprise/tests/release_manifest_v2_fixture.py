...
def release_manifest(*, release_id: str = "release-A", runtime_manifest_sha256: str = "c" * 64, python_version: str = "3.14.6", python_abi: str = "cp314", architecture: str = "x64"):
    ...
    payload = {
        ...
        "payload_policy": {"schema_version": "ops-release-payload-policy-v1", "git_path": "release/windows/release-payload-policy.json", "git_blob_sha1": COMMIT, "payload_path": "release-evidence/release-payload-policy.json", "sha256": SHA},
        ...
        "licenses": {"machine_inventory_path": "evidence/licenses.json", "machine_inventory_sha256": SHA, "component_policy_path": "evidence/license-policy.json", "component_policy_sha256": SHA, "human_notice_path": "THIRD-PARTY-LICENSES.txt", "human_notice_sha256": SHA, "component_count": 1, "unresolved_count": 0, "legal_review_complete": False, "inventory_complete": True},
