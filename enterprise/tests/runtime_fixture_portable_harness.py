...
def main() -> int:
    ...
    config = SupervisorConfig(
        ...
        release_manifest_sha256=evidence.result.release_manifest_sha256,
        release_payload_tree_sha256=evidence.result.release_payload_tree_sha256,
        enterprise_commit=evidence.result.enterprise_commit,
        enterprise_tree=evidence.result.enterprise_tree,
